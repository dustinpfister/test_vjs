...
* (done) update forpost folder for js-getting-started-javascript-console to reflect current state of page at least
* (done) have a todo list for js-getting-started-javascript-console
* (done) make at least one more s2 example for js-getting-started-javascript-console
...
* (done) work on js-example-game-framework

### (done) for for 09/03/2021
* (done) work on js-javascript-example-game-framework
* (done) write mew post on js-javascript-example-game-framework
* (done) edit js-javascript-example
...
* (done) js-javascript-example-game-framework
* (done) edit js javascript-module-object-literal
